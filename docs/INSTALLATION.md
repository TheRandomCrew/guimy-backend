...
2.- Open a Terminal from `guimy-backend/` (the folder with `docker-compose.yml` file) and run
...
PRODUCTION_URL= # Add a link to whitelist, expected https://guimy.herokuapp.com
```
...
[download the code]: https://github.com/Israel-Laguan/guimy-backend/archive/master.zip
